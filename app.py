...
def ask():
    ...
    headers = {
        ...
        "HTTP-Referer": "https://revela-ai.onrender.com",
        "X-Title": "Revela AI"
    }
    ...
    try:
        ...
        print(response_json)  # Pour déboguer dans les logs Render
        reply = response_json["choices"][0]["message"]["content"]
    except requests.exceptions.RequestException as e:
        reply = f"Erreur API (requête) : {str(e)}"
    except KeyError:
        reply = f"Erreur API : Clé 'choices' introuvable. Réponse brute : {response_json}"
